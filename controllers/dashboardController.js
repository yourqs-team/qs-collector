...
exports.updateProject = async (req, res) => {
  ...
  await project.Interior_finish.update({
    ...
    kitchen_floor_covering_other: req.body.interiorFinish_kitchen_floor_covering_other,
    kitchen_wall_finish_other: req.body.interiorFinish_kitchen_wall_finish_other,
    ...
    living_floor_covering_other: req.body.interiorFinish_living_floor_covering_other,
    living_wall_finish_other: req.body.interiorFinish_living_wall_finish_other,
    ...
    bedrooms_floor_covering_other: req.body.interiorFinish_bedrooms_floor_covering_other,
    bedrooms_wall_finish_other: req.body.interiorFinish_bedrooms_wall_finish_other,
    ...
    bathroom_floor_covering_other: req.body.interiorFinish_bathroom_floor_covering_other,
    bathroom_wall_finish_other: req.body.interiorFinish_bathroom_wall_finish_other,
    ...
    ensuite_floor_covering_other: req.body.interiorFinish_ensuite_floor_covering_other,
    ensuite_wall_finish_other: req.body.interiorFinish_ensuite_wall_finish_other,
    ...
    laundry_floor_covering_other: req.body.interiorFinish_laundry_floor_covering_other,
    laundry_wall_finish_other: req.body.interiorFinish_laundry_wall_finish_other,
